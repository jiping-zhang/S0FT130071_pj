...
{
    public static final String IMAGE_FOLDER_PATH= GetProjectDictroyPath.getPackageString()+"out\\artifacts\\pj_war_exploded\\sources\\img\\";
    public static final String IMAGE_FOLDER_PATH_IN_PJ="sources\\img\\";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            TravelImageDAO.addImageIntoSQL(travelImage);
            //TravelImageDAO.
        }
