...
<header id="navBox">
    ...
    <div class="singleMenu" id="navRight">
        ...
        <div class="singleCont">
            ...
            <br>
            <a href="myFavoriteServlet"><span class="singleItem" id="selected"><img
...
<%
    /*ArrayList<TravelImage> favoriteImages = (ArrayList<TravelImage>)session.getAttribute("favorImages");
...
<section id="content">
    <div class="contRow title">
        我的收藏
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="myHistoryServlet">我的足迹</a>
    </div>
    <%
    ...
    <div class="contRow">
        ...
        <div class="singleItem">
            ...
            <button class="deleteFavorBt" <%=hasNext ? ("onclick=\"window.location.href='addAndDeleteFavorServlet?imageID=" + travelImage.getImageID() + "'\"") : ""%>>
                取消收藏
            </button>
        </div>
    </div>
    ...
    <div class="contRow_bottom" id="pageBox">
        <ul>
            <%
                ...
                String uri = "myFavoriteServlet?" + "&pageIndex=";
            %>
